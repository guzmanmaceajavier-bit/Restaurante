...
export default function AdminCaja() {
  ...
  const agregar = () => { if(!form.concepto.trim()||!form.monto) { toast.error('Concepto y monto requeridos'); return } saveMovs([...movs, {id:'mov_'+Date.now(), ...form}]); toast.success('Movimiento registrado'); setShowMov(false)}
  return (
    <div>
      <SEO title="Caja" />
